...
void plotGraphs() {
    ...
    const char* file1 = "VR_VL_Lissajous/VR_VL_3kHz.txt";
    const char* file2 = "VR_VL_Lissajous/VR_VL_resonance.txt";
    const char* file3 = "VR_VL_Lissajous/VR_VL_12kHz.txt";
    ...
    graph1->GetXaxis()->SetLimits(xMin - 0.6, xMax + 0.6);
    graph1->SetMinimum(yMin - 0.45);
    graph1->SetMaximum(yMax + 0.45);

    // Disegno del primo grafico
    graph1->SetTitle("VR vs VL;VL (V);VR (V)");
